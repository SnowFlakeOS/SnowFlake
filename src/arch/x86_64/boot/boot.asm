...
%include "src/arch/x86_64/boot/include/globals.inc"      ; Global variable definitions
...
; Display strings
String.Loader.Found     db      "[Flake] Loader found",          0x0d, 0x0a, 0
String.Loader.Starting  db      "[FLAKE] Loader starting",       0x0d, 0x0a, 0
String.Fail             db      "[FLAKE] ERROR: Failed to load", 0x0d, 0x0a, 0
